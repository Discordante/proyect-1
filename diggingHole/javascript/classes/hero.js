class Hero{
    ...
    collision(enemy){
        ...
        if (    //---collision down---
                ...
                this.pos.y + this.height > enemy.pos.y + enemy.height &&
                this.previousY > enemy.pos.y + enemy.height
                ) 
                {
                    //console.log('down')
                    this.pos.y = enemy.pos.y + enemy.height + 1
                    this.vel.y = 0   
                    this.vel.x = 0
                ...
                this.pos.x <= enemy.pos.x + enemy.width &&
                this.pos.y < enemy.pos.y && 
                this.previousY + this.height < enemy.pos.y) 
            
                {
                    //console.log('up')
                    this.pos.y  = enemy.pos.y - this.height - 1
                    this.vel.y = 0
                    this.vel.x = 0
                ...
                this.previousX +  this.width < enemy.pos.x)
        
                {
                    //console.log('left')
                    this.pos.x  = enemy.pos.x - this.width - 1
                    this.vel.x = 0
                ...
                this.pos.y <= enemy.pos.y + enemy.height &&
                this.pos.x <= enemy.pos.x + enemy.width &&
                this.pos.x + this.width > enemy.pos.x + enemy.width &&
                this.previousX > enemy.pos.x + enemy.width
                ) 

                {
                    //console.log('right')
                    this.pos.x  = enemy.pos.x + enemy.width + 1
                    this.vel.x = 0
